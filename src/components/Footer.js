...
export default function Footer() {
  return (
    <>
      <div className="styles__Container-z2pj6q-0 iInxwT">
              <div className="styles__Content-z2pj6q-1 jBerFE"><span>Let’s talk about your project</span>
                  <p>Ready to take it to the next level? Contact us today and find out how our expertise can help
                      your business grow.</p>
              </div><a className="Button__StyledLink-t1csmo-0 hjUNgl" href="/contact">Get in touch</a>
          </div>
      <footer className="styles__Footer-sc-1xjizq-0 gHJLCE">
          <div className="styles__InnerWrapper-sc-1xjizq-1 kGEwnt">
              <nav className="styles__Nav-sc-1xjizq-2 gmdHma">
                  <div className="styles__LogoWrapper-sc-1xjizq-3 eSkXpe"><a aria-current="page" className=""
                      href="/"><img
              ...
              <div className="styles__ContactWrapper-sc-1xjizq-6 bDKHYw">
                  <div className="styles__ContactRow-sc-1xjizq-4 hQQvvH">
                      <h4>Designo
                          Central Office
                  ...
                  <ul className="styles__SocialsList-sc-1xjizq-5 qajti">
                      ...
                      <li aria-labelledby="Pinterest-label"><span id="Pinterest-label"
                          hidden=""></span><a href="https://pinterest.com"><img
                      ...
                      <li aria-labelledby="Instagram-label"><span id="Instagram-label"
                          hidden=""></span><a href="https://instagram.com"><img
